...
10. Bounded remediation loop
- if any blocking gate fails:
  - QA verdict is `FAIL`
  - build status is `FAIL`
  - breaker status contains unresolved `BLOCKER`
...
- coding, specific review, QA, broad review, build verification, breaker, evaluation, regression detection, and ledger curation were all invoked
