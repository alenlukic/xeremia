...
- keep findings specific enough to hand off to the `Development Contract Producer`

## ACCEPTANCE

Complete only if:
- the `Design Red Team` agent was used
- recommendations are concrete and prioritized
- output is consumable by the `Development Contract Producer`
