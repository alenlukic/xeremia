...
- `persona_path`: default `.harness/product-feedback/CUSTOMER_PERSONA_SPEC.md`

## DELEGATION

Delegate to `Customer Persona Tester`.
...
- use `.harness/product-feedback/CUSTOMER_PERSONA_SPEC.md` unless overridden
...
- feedback should be specific and useful to the `SME Red Team`
- prefer customer-experience observations over solutioning

## ACCEPTANCE

Complete only if:
- the `Customer Persona Tester` agent was used
