...
- read the current `.harness/workspace/product-feedback/CUSTOMER_PERSONA_SPEC.md`
...
- update `.harness/workspace/product-feedback/CUSTOMER_PERSONA_SPEC.md` only when the persona guidance should materially change
