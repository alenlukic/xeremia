...
1. Initialize
- use the `SME Research Analyst` agent
- if no explicit output path is provided, write to:
  - `.harness/knowledge/docs/design-docs/REPO_RESEARCH_REPORT.md`
...
Produce:
- `.harness/knowledge/docs/design-docs/REPO_RESEARCH_REPORT.md` unless overridden
...
Complete only if:
- the SME Research Analyst agent was used
