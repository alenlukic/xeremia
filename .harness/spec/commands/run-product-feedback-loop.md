...
- `python3 .harness/control/bin/pipeline.py start --mode product_feedback --task <focus or default summary>`
...
- update `.harness/workspace/product-feedback/CUSTOMER_PERSONA_SPEC.md` if it materially improves
...
- update `.harness/workspace/product-feedback/RECOMMENDATION_REGISTRY.json` and `.harness/workspace/product-feedback/RECOMMENDATION_REGISTRY.md`
...
- record linkage with `python3 .harness/control/bin/pipeline.py record-follow-on ...` when appropriate
