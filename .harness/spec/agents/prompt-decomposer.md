...
Optional:
- `output_dir`: filesystem path; if provided, write child prompts here. If omitted, write child prompts to `.harness/knowledge/docs/prompts`. Prefix file names with current timestamp in 24-hour `YYYY-MM-DD-HH:MM:SS` format.
