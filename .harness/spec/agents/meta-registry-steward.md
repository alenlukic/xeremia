...
Update both:
- `.harness/workspace/product-feedback/RECOMMENDATION_REGISTRY.json` (canonical)
- `.harness/workspace/product-feedback/RECOMMENDATION_REGISTRY.md` (human-readable snapshot)
