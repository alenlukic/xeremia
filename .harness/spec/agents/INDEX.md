...
Canonical agent definitions, grouped by prefixed role.
...
- [dev-delivery-coder.md](dev-delivery-coder.md)
- [dev-restructure-coder.md](dev-restructure-coder.md)

## Maintenance (`maint-`)

- [maint-coder.md](maint-coder.md)
- [maint-comment-scrubber.md](maint-comment-scrubber.md)
- [maint-reviewer.md](maint-reviewer.md)
...
- [prompt-decomposer.md](prompt-decomposer.md)
...
- [test-breaker-security.md](test-breaker-security.md)
- [test-breaker-spec.md](test-breaker-spec.md)
- [test-breaker-tests.md](test-breaker-tests.md)
- [test-build-verifier.md](test-build-verifier.md)
- [test-customer-persona.md](test-customer-persona.md)
- [test-delivery-broad-reviewer.md](test-delivery-broad-reviewer.md)
- [test-delivery-evaluator.md](test-delivery-evaluator.md)
- [test-delivery-qa.md](test-delivery-qa.md)
- [test-delivery-reviewer.md](test-delivery-reviewer.md)
- [test-design-qa.md](test-design-qa.md)
- [test-regression-detector.md](test-regression-detector.md)
