...
Provide the task inline. The pipeline creates one run directory under `.harness/history/runs/<run_id>/` with standard artifacts.
...
- Its own run directory: `.harness/history/runs/<run_id>/`
...
```
.harness/history/runs/batch-<timestamp>/
  BATCH_REPORT.json
```
...
```
.harness/history/runs/<run_id_1>/
  TASK.md, PLAN.md, PATCH.diff, TEST_REPORT.json, ...
.harness/history/runs/<run_id_2>/
  TASK.md, PLAN.md, PATCH.diff, TEST_REPORT.json, ...
```
...
```json
{
  ...
  "batch_dir": ".harness/history/runs/batch-20260402T170000Z",
  ...
  "tasks": [
    {
      ...
      "run_dir": ".harness/history/runs/20260402T170001Z",
      "status": "pass",
    ...
    },
    {
      ...
      "run_dir": ".harness/history/runs/20260402T172001Z",
      "status": "pass",
