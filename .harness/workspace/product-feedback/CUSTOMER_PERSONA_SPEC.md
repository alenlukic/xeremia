...
4. **Collection audit:** Browse by key/BPM/genre to identify gaps ("I have nothing in 4A around 124 BPM") or oversaturation. *(April 2026: Browse, Matches, and Pool now support multi-sort, and Browse restores prior list position when the user returns from adjacent workflows.)*
