...
/* Subgroup auto-assign on search-add tests removed — Phase A removed the always-visible
   pool search input. Search-to-add is now only available via fill mode on empty rows. */
